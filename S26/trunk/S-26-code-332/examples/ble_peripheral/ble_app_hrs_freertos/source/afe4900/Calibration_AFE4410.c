...
const unsigned long ILED_CURR_MIN_code = 70; 							// LED min current reqd. for application - 3.2 mA assuming 100mA range (This is default value)
...
unsigned long AFE44xx_Current_Register_Settings[5] = { 0, 0, 0, 0, 0 };
// Array that holds the latest AFE register settings
...
{
	AFE4410_Reg_Write(0x00, 0x000062);              //CONTROL0
	AFE4410_Reg_Write(0x01, 0x00002B);              //LED2STC
	AFE4410_Reg_Write(0x02, 0x000037);              //LED2ENDC
	AFE4410_Reg_Write(0x03, 0x00004B);              //LED1LEDSTC
	AFE4410_Reg_Write(0x04, 0x00005B);              //LED1LEDENDC
	AFE4410_Reg_Write(0x05, 0x00003D);              //ALED2STC
	AFE4410_Reg_Write(0x06, 0x000049);              //ALED2ENDC
	AFE4410_Reg_Write(0x07, 0x00004F);              //LED1STC
	AFE4410_Reg_Write(0x08, 0x00005B);              //LED1ENDC
	AFE4410_Reg_Write(0x09, 0x000027);              //LED2LEDSTC
	AFE4410_Reg_Write(0x0A, 0x000037);              //LED2LEDENDC
	AFE4410_Reg_Write(0x0B, 0x000061);              //ALED1STC
	AFE4410_Reg_Write(0x0C, 0x00006D);              //ALED1ENDC
	AFE4410_Reg_Write(0x0D, 0x000039);              //LED2CONVST
	AFE4410_Reg_Write(0x0E, 0x000050);              //LED2CONVEND
	AFE4410_Reg_Write(0x0F, 0x000052);              //ALED2CONVST
	AFE4410_Reg_Write(0x10, 0x000069);              //ALED2CONVEND
	AFE4410_Reg_Write(0x11, 0x00006B);              //LED1CONVST
	AFE4410_Reg_Write(0x12, 0x000082);              //LED1CONVEND
	AFE4410_Reg_Write(0x13, 0x000084);              //ALED1CONVST
	AFE4410_Reg_Write(0x14, 0x00009B);              //ALED1CONVEND
	AFE4410_Reg_Write(0x1D, 0x0009FF);              //PRPCOUNT
	AFE4410_Reg_Write(0x1E, 0x000102);              //CONTROL1
	AFE4410_Reg_Write(0x1F, 0x002525);              //TIAGAIN_2_3
	AFE4410_Reg_Write(0x20, 0x008025);              //TIAGAIN
#ifdef AMB_DAC_MODE
	AFE4410_Reg_Write(0x21, 0x005225);              //TIA_AMB_GAIN
#else
	AFE4410_Reg_Write(0x21, 0x000225);              //TIA_AMB_GAIN
#endif
	AFE4410_Reg_Write(0x22, 0xA91451);              //LEDCNTRL1
	AFE4410_Reg_Write(0x23, 0x10C218);              //CONTROL2
	AFE4410_Reg_Write(0x24, 0x000000);              //LEDCNTRL2
	AFE4410_Reg_Write(0x28, 0x000000);              //TOGGLE
	AFE4410_Reg_Write(0x29, 0x000000);              //CLKDIV1
	AFE4410_Reg_Write(0x2A, 0x000000);              //LED2VAL
	AFE4410_Reg_Write(0x2B, 0x000000);              //ALED2VAL
	AFE4410_Reg_Write(0x2C, 0x000000);              //LED1VAL
	AFE4410_Reg_Write(0x2D, 0x000000);              //ALED1VAL
	AFE4410_Reg_Write(0x2E, 0x000000);              //LED2-ALED2VAL
	AFE4410_Reg_Write(0x2F, 0x000000);              //LED1-ALED1VAL
	AFE4410_Reg_Write(0x31, 0x000000);              //CONTROL3
	AFE4410_Reg_Write(0x34, 0x000000);              //PROG_INT2_STC
	AFE4410_Reg_Write(0x35, 0x000000);              //PROG_INT2_ENDC
	AFE4410_Reg_Write(0x36, 0x000039);              //LED3LEDSTC
	AFE4410_Reg_Write(0x37, 0x000049);              //LED3LEDENDC
	AFE4410_Reg_Write(0x39, 0x000000);              //CLKDIV2
												   //	  AFE4410_Reg_Write(0x3A, 0x184210);              //OFFDAC
	AFE4410_Reg_Write(0x3A, (0x184210 & (~(0x000001 << 20))) | (afe4410_ppg_param_s.set_early_offset_loop << 20));              //OFFDAC
	AFE4410_Reg_Write(0x3B, 0x000000);              //THRDETLOW
	AFE4410_Reg_Write(0x3C, 0x200000);              //THRDETHIGH
	AFE4410_Reg_Write(0x3D, 0x000000);              //THRDET
	AFE4410_Reg_Write(0x3E, 0x000000);              //I_OFFDAC
	AFE4410_Reg_Write(0x3F, 0x000000);              //AVG_LED2_ALED2VAL
	AFE4410_Reg_Write(0x40, 0x000000);              //AVG_LED1_ALED1VAL
												   //	  AFE4410_Reg_Write(0x42, 0x000000);              //FIFO
	AFE4410_Reg_Write(0x42, 0x000000 | (4 << 6) | (0x02 << 4) | (0x00 << 0));
	AFE4410_Reg_Write(0x43, 0x00005D);              //LED4LEDSTC
	AFE4410_Reg_Write(0x44, 0x00006D);              //LED4LEDENDC
	AFE4410_Reg_Write(0x45, 0x000000);              //TG_PD1STC
	AFE4410_Reg_Write(0x46, 0x000000);              //TG_PD1ENDC
	AFE4410_Reg_Write(0x47, 0x000000);              //TG_PD2STC
	AFE4410_Reg_Write(0x48, 0x000000);              //TG_PD2ENDC
	AFE4410_Reg_Write(0x49, 0x000000);              //TG_PD3STC
	AFE4410_Reg_Write(0x4A, 0x000000);              //TG_PD3ENDC
	AFE4410_Reg_Write(0x4B, 0x000000);              //CONTROL4
	AFE4410_Reg_Write(0x4E, 0x000000);              //DUAL_PD
	AFE4410_Reg_Write(0x50, 0x000008);              //CONTROL5
	AFE4410_Reg_Write(0x51, 0x000000);              //FIFO_OFFSET
	AFE4410_Reg_Write(0x52, 0x0000A1);              //DATA_RDY_STC
	AFE4410_Reg_Write(0x53, 0x0000A1);              //DATA_RDY_ENDC
	AFE4410_Reg_Write(0x57, 0x000000);              //PROG_INT1_STC
	AFE4410_Reg_Write(0x58, 0x000000);              //PROG_INT1_ENDC
#ifdef AMB_DAC_MODE
	AFE4410_Reg_Write(0x60, 0x000E38
...
#else
												   // FWT 20190222 CHANGE
	AFE4410_Reg_Write(0x60, 0x000000);              //AMB_CANCELLATION
#endif
	AFE4410_Reg_Write(0x64, 0x000000);              //DYN_TIA_STC
	AFE4410_Reg_Write(0x65, 0x00009E);              //DYN_TIA_ENDC
	AFE4410_Reg_Write(0x66, 0x000000);              //DYN_ADC_STC
	AFE4410_Reg_Write(0x67, 0x00009E);              //DYN_ADC_ENDC
	AFE4410_Reg_Write(0x68, 0x000000);              //DYN_CLOCK_STC
	AFE4410_Reg_Write(0x69, 0x00009E);              //DYN_CLOCK_ENDC
	AFE4410_Reg_Write(0x6A, 0x0000A8);              //DEEP_SLEEP_STC
	AFE4410_Reg_Write(0x6B, 0x900000);              //DEEP_SLEEP_ENDC
	AFE4410_Reg_Write(0x6C, 0x000000);              //PD_SHORT
	AFE4410_Reg_Write(0x6D, 0x000000);              //REG_POINTER
	AFE4410_Reg_Write(0x72, 0x000000);              //LED_DRIVER_CONTROL
	AFE4410_Reg_Write(0x73, 0x000000);              //THR_DETECT_LOGIC
	AFE4410_Reg_Write(0xC8, 0x000000);              //CLOCK_SETTINGS
	AFE4410_Reg_Write(0x00, 0x000063);             //AFE4900READ MODE AND ULP
}
...
void initCalibrationRoutine(void)
{
	...
	LED_pulse_width = 120;  //LED pulse width in us
						   //AFE4410 change
	...
	if (Calibration_enabled != 0)
	{
		...
		AFE4410_Reg_Write(AFE_CONTROL0, 0x00000062); // write mode
		...
		AFE4410_Reg_Write(AFE_CONTROL0, 0x00000063); // read mode
	}
