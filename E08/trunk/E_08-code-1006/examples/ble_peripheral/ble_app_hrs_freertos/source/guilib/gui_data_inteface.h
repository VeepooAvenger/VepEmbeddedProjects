...
typedef enum
{
    ...
    GUI_LANGUAGE_JAPANESE,          //日语
    GUI_LANGUAGE_KOREAN,            //韩语
    GUI_LANGUAGE_GERMAN,            //德语
    GUI_LANGUAGE_RUSSIAN,           //俄语
    GUI_LANGUAGE_SPANISH,           //西班牙语
    GUI_LANGUAGE_ITALIARN,          //意大利语
    GUI_LANGUAGE_FRENCH,            //法语
    GUI_LANGUAGE_VIETNAMESE,        //越南语
    GUI_LANGUAGE_PORTUGUESE,        //葡萄牙语
    GUI_LANGUAGE_TRADITIONAL,       //繁体
}GUI_LANGUAGE_E;
