...
/****************************************************************
** Function name:           App_Crc16
** Descriptions:            crc校验
** input parameters:        data:数据；len:长度
** output parameters:       无
** Returned value:          返回crc校验值
** Created by:              WJ             
** Created Date:            2017-08-21
**----------------------------------------------------------------
** Modified by:
...
/****************************************************************
** Function name:           App_Crc16ByCrc16
** Descriptions:            crc校验，并与前一个crc校验值并入计算
** input parameters:        crc16：初始crc; data:数据；len:长度
** output parameters:       无
** Returned value:          返回crc校验值
** Created by:              WJ             
** Created Date:            2017-08-21
