                                              ...
                                              ble_enable_params_t * p_ble_enable_params)
{
    ...
    p_ble_enable_params->common_enable_params.vs_uuid_count   = 6;//3;//2; // 1; 这里与uart serivice 数量相关
...
uint32_t softdevice_enable(ble_enable_params_t * p_ble_enable_params)
{
    ...
    //WJ.20181220.test.0x00002178 ==>8.4K Byte
    //sdk_ram_test = ram_end_address_get() - app_ram_base;    
