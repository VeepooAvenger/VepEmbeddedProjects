...
{
    ICON_MAIN3_ICON1_01_ADDR + FLASH_GT_SIZE, ICON_MAIN3_ICON1_01_ADDR + FLASH_GT_SIZE,
};
const uint32_t clock_m_addr[2] = 
{
    ICON_MAIN3_ICON2_01_ADDR + FLASH_GT_SIZE, ICON_MAIN3_ICON2_01_ADDR + FLASH_GT_SIZE,
};
