 ...
 */
uint32_t ble_Ancs_DbDiscoveryInit(ble_db_discovery_evt_handler_t evt_handler);
 ...
 *          ble_Ancs_DbDiscoveryInit must be called again.
 *
 ...
 * @retval    NRF_ERROR_NULL            When a NULL pointer is passed as input.
 * @retval    NRF_ERROR_INVALID_STATE   If this function is called without calling the
 *                                      @ref ble_Ancs_DbDiscoveryInit, or without calling
