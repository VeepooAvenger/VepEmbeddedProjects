...
/****************************************************************
** Function name:           Product_GetBpFunction
...
/****************************************************************
** Function name:           Product_SetSitFunction
...
void Product_SetSitFunction(uint8_t sit_function)
{
    ...
    if(product_info_s.attr.sit_flag != sit_function)
    {
        App_FlashEraseProductInformation();
        nrf_delay_ms(100);
        
        product_info_s.attr.sit_flag = sit_function;
...
/****************************************************************
** Function name:           Product_GetSitFunction
...
uint8_t Product_GetSitFunction(void)
{
    ...
    return product_info_s.attr.sit_flag;   
}



/****************************************************************
** Function name:           Product_SetLowEnergeFunction
** Descriptions:            设置低功耗控制功能模块
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              WJ            
...
void Product_SetLowEnergeFunction(low_energe_protocol_data_t *low_energe_para)
{
    ...
    if( product_info_s.attr.state != low_energe_para->state ||
        product_info_s.attr.notice_time_value != low_energe_para->notice_time_value ||
        product_info_s.attr.posture_time_value != low_energe_para->posture_time_value || 
        product_info_s.attr.normal_light_time_value != low_energe_para->normal_light_time_value || 
        product_info_s.attr.motor_delay_time_value != low_energe_para->motor_delay_time_value ||
        product_info_s.attr.moter_time_value != low_energe_para->moter_time_value   )
    {
        App_FlashEraseProductInformation();
        nrf_delay_ms(100);
        
        product_info_s.attr.state = low_energe_para->state;
        product_info_s.attr.notice_time_value = low_energe_para->notice_time_value;
        product_info_s.attr.posture_time_value = low_energe_para->posture_time_value;
        product_info_s.attr.normal_light_time_value = low_energe_para->normal_light_time_value; 
        product_info_s.attr.motor_delay_time_value = low_energe_para->motor_delay_time_value;
...
/****************************************************************
** Function name:           Product_GetLowEnergeFunction
** Descriptions:            获取低功耗控制功能模块
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              WJ            
...
uint8_t Product_GetLowEnergeFunction(low_energe_protocol_data_t *low_energe_para)
{
   ...
   low_energe_para->state =  product_info_s.attr.state;
   low_energe_para->notice_time_value =  product_info_s.attr.notice_time_value;
   low_energe_para->posture_time_value =  product_info_s.attr.posture_time_value;
   low_energe_para->normal_light_time_value =  product_info_s.attr.normal_light_time_value; 
   low_energe_para->motor_delay_time_value =  product_info_s.attr.motor_delay_time_value;
   low_energe_para->moter_time_value =  product_info_s.attr.moter_time_value;   
