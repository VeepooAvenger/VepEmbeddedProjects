...
//    static uint8_t last_level_level = 0;
    ...
    if(battery_v < 3.60f)//3.547f) //3.45f)  94mA
    {
        battery_low_cnt++;
        c_battery_grade = BATTERY_LEVEL_LOW;
    }
    else if(battery_v < 3.650f)//3.623f)//3.53f) 88mA
    {
        c_battery_grade = 0;
        battery_low_cnt = 0;
    }   
    else if(battery_v < 3.698f)//3.62f) 68mA
    {
        c_battery_grade = 1;
        battery_low_cnt = 0;
    }   
    else if(battery_v < 3.763f)//3.68f)48mA
    {
        c_battery_grade = 2;
        battery_low_cnt = 0;
    }
    else if(battery_v < 3.918f)//3.85f) 20mA
    {
        c_battery_grade = 3;
        battery_low_cnt = 0;
    }
    ...
    {  
        if(Battery_IsCharging() && battery_v < 3.98f)
        {
            c_battery_grade = 3;
            battery_low_cnt = 0;
        }
