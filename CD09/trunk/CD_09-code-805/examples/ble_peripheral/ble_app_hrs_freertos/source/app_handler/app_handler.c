...
extern low_energe_protocol_data_t low_energe_protocol_data; //低功耗控制参数
...
{    
    ...
    //低电并且非充电时进行关机
    if(Battery_IsLowToShut() && !Battery_IsCharging())
    {
...
/*******************************************************************************
** Function name:           App_PowerOffSystemInfoSave
** Descriptions:            关机保存系统参数
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              JSH              
...
**------------------------------------------------------------------------------
*******************************************************************************/
void App_PowerOffSystemInfoSave(void)
{
    if(system_flag_s.system_info_save)
    {
        App_FlashEraseCheck();
...
//        // JSH.20180716.清除数据关机，判断是否需要清除数据
//        if(system_flag_s.power_off_clear == 1)
//        {
//            system_flag_s.power_off_clear = 0;
//            
//            All_StepCln();
//            All_StepSet(0);
//            Work_MeasrueCln();       
...
//        }
        ...
        // JSH.20180716.关机如需保存数据就保存数据
        Alarm_PowerOffSave();
        Phys_PowerOffSave();
        App_PowerOffSystemInfoSave();
    }
}
...
/*******************************************************************************
** Function name:           App_SetSitFunctionHandler
** Descriptions:            设置久坐功能模块开启和关闭
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              WJ              
...
**------------------------------------------------------------------------------
*******************************************************************************/
void App_SetSitFunctionHandler(void)
{       
   Product_SetSitFunction(system_flag_s.sit_flag);
}

/*******************************************************************************
** Function name:           App_SetLowEnergeFunctionHandler
** Descriptions:            设置低功耗控制参数
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              WJ              
...
**------------------------------------------------------------------------------
*******************************************************************************/
void App_SetLowEnergeFunctionHandler(void)
{       
   Product_SetLowEnergeFunction(&low_energe_protocol_data);
}

/*******************************************************************************
** Function name:           App_CheckLowEnergeFunctionHandler
** Descriptions:            检查低功耗控制参数
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              ZJH              
...
**------------------------------------------------------------------------------
*******************************************************************************/
uint8_t  App_CheckLowEnergeFunctionHandler(void)
{
   return Config_LowEnergeCheck();
}

/*******************************************************************************
** Function name:           App_LowEnergeFunctionInitHandler
** Descriptions:            低功耗控制参数初始化
** input parameters:        无
** output parameters:       无
** Returned value:          无
** Created by:              ZJH              
...
**------------------------------------------------------------------------------
*******************************************************************************/
void App_LowEnergeFunctionInitHandler(void)
{
