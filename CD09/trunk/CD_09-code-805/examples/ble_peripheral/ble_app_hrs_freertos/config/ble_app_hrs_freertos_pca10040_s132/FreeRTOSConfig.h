...
#define configTOTAL_HEAP_SIZE                                                     (16384) //( 4096 )    //16K
...
#define configCHECK_FOR_STACK_OVERFLOW                                            0//1 //WJ.20170310
...
#define configTIMER_QUEUE_LENGTH                                                  32 * 2
#define configTIMER_TASK_STACK_DEPTH                                              ( 80 * 2)
