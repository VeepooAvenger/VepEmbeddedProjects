...
#ifdef APP_IIC1
#define IIC1_SCL    LCD_SCL_PIN//I2C_CLK_PIN
#define IIC1_SDA    LCD_SDA_PIN//I2C_DAT_PIN
#endif
...
#define TWI_DELAY()         while(0);//nrf_delay_us(2) /*!< Time to wait when pin states are changed. For fast-mode the delay can be zero and for standard-mode 4 us delay is sufficient. */
