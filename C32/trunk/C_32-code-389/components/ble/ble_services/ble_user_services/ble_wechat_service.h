...
#define BLE_UUID_WECHAT_WRITE_CHARACTERISTICS 		0xFEA2
#define BLE_UUID_WECHAT_INDICATE_CHARACTERISTICS 	0xFEA1
...
uint32_t ble_wcs_data_update(uint16_t conn_handle,ble_wechat_t * p_wcs);

int ble_wechat_send_data(uint32_t all_step_t);
