                          ...
                          uint8_t temperature_high)
{
    ...
    if(main_background_color == 0)
    {
        ...
        LCD_SetPosition(icon_16_main_bj_coord[0][0], icon_16_main_bj_coord[0][1], 
                        ICON_MAIN_ICON1_WIDE, ICON_MAIN_ICON1_HIGH);
        LCD_DriverWriteDataFromExtFlash(icon_16_main_bj_addr[4], ICON_MAIN_ICON1_SIZE);              
    ...
    if(main_background_color == 1)
    {
        ...
        LCD_SetPosition(icon_16_main_bj_coord[0][0], icon_16_main_bj_coord[0][1], 
                        ICON_MAIN_ICON1_WIDE, ICON_MAIN_ICON1_HIGH);
        LCD_DriverWriteDataFromExtFlash(icon_16_main_bj_addr[0], ICON_MAIN_ICON1_SIZE);              
    ...
    if(main_background_color == 2)
    {
        ...
        LCD_SetPosition(icon_16_main_bj_coord[0][0], icon_16_main_bj_coord[0][1], 
                        ICON_MAIN_ICON1_WIDE, ICON_MAIN_ICON1_HIGH);
        LCD_DriverWriteDataFromExtFlash(icon_16_main_bj_addr[1], ICON_MAIN_ICON1_SIZE);              
    ...
    if(main_background_color == 3)
    {
        ...
        LCD_SetPosition(icon_16_main_bj_coord[0][0], icon_16_main_bj_coord[0][1], 
                        ICON_MAIN_ICON1_WIDE, ICON_MAIN_ICON1_HIGH);
        LCD_DriverWriteDataFromExtFlash(icon_16_main_bj_addr[2], ICON_MAIN_ICON1_SIZE);              
    ...
    if(main_background_color == 4)
    {
        ...
        LCD_SetPosition(icon_16_main_bj_coord[0][0], icon_16_main_bj_coord[0][1], 
                        ICON_MAIN_ICON1_WIDE, ICON_MAIN_ICON1_HIGH);
        LCD_DriverWriteDataFromExtFlash(icon_16_main_bj_addr[3], ICON_MAIN_ICON1_SIZE);              
...
//            LCD_SetPosition(icon_16_mh3_mb1_coord[0][0], icon_16_mh3_mb1_coord[0][1], 
//                            ICON_STOPWATCH_ICON3_WIDE, ICON_STOPWATCH_ICON3_HIGH);
//            LCD_DriverWriteDataFromExtFlash(icon_16_mh3_mb1_addr[0], ICON_STOPWATCH_ICON3_SIZE);
//            
//            LCD_SetPosition(icon_16_mh3_mb1_coord[1][0], icon_16_mh3_mb1_coord[1][1], 
//                            ICON_STOPWATCH_ICON3_WIDE, ICON_STOPWATCH_ICON3_HIGH);
//            LCD_DriverWriteDataFromExtFlash(icon_16_mh3_mb1_addr[3], ICON_STOPWATCH_ICON3_SIZE);
...
//        LCD_SetPosition(icon_16_mh3_mb1_coord[0][0], icon_16_mh3_mb1_coord[0][1], 
//                            ICON_STOPWATCH_ICON3_WIDE, ICON_STOPWATCH_ICON3_HIGH);
//        LCD_DriverWriteDataFromExtFlash(icon_16_mh3_mb1_addr[1], ICON_STOPWATCH_ICON3_SIZE);
//        
//        LCD_SetPosition(icon_16_mh3_mb1_coord[1][0], icon_16_mh3_mb1_coord[1][1], 
//                            ICON_STOPWATCH_ICON3_WIDE, ICON_STOPWATCH_ICON3_HIGH);
//        LCD_DriverWriteDataFromExtFlash(icon_16_mh3_mb1_addr[2], ICON_STOPWATCH_ICON3_SIZE);
    }
...
void Gui_PageAlarm(uint8_t am_pm_format, uint8_t scene, uint8_t hour, uint8_t minute, uint8_t language, uint8_t index)
{
	...
	if(scene == 0)
    {
        ...
        {
            /* 动图*/
//            LCD_SetPosition(icon_16_mh3_clock7_coord[0][0], icon_16_mh3_clock7_coord[0][1], 
//                            ICON_CLOCK_ICON6_WIDE, ICON_CLOCK_ICON6_HIGH);
//            LCD_DriverWriteDataFromExtFlash(icon_16_mh3_clock7_addr[0], ICON_CLOCK_ICON6_SIZE);
...
//        /* 动图*/
//        LCD_SetPosition(icon_16_mh3_clock4_coord[0][0], icon_16_mh3_clock4_coord[0][1], 
//                        ICON_CLOCK_ICON3_WIDE, ICON_CLOCK_ICON3_HIGH);
//        LCD_DriverWriteDataFromExtFlash(icon_16_mh3_clock4_addr[index % 2], ICON_CLOCK_ICON3_SIZE);
...
////        LCD_DriverWriteDataFromExtFlash(icon_16_mh3_call2_addr[0], ICON_CALL_ICON4_HIGH);
//    }    
//    
//    if(index == 0)
//    {        
...
//            LCD_DriverWriteDataFromExtFlash(icon_16_mh3_call2_addr[0], 31790);
//        
//        Font_DisplayContentText(display_buf, buf_len, icon_16_call_text_coord[0][1], PER_PAGE_MAX_ROWS);
////        Font_DisplayContentText(display_buf, buf_len, icon_16_call_text_coord[0][1], PER_PAGE_MAX_ROWS);
//    }
...
** Created Date:            2018-06-05
*****************************************************************/
void Gui_PagePHY(uint8_t index,uint8_t menstrual)
{
    if(menstrual == 0)
    {
        cpu_s.task++; 
