...
{
     system_info_s.gesture_level = 4;  //C-32_428客户要求等级默认为4
}
/****************************************************************
...
{
    system_info_s.turnwrist_config.enable = 0;
...
void Config_BrightnessLeveCheck(void)
{
    ...
    if((system_info_s.brightness_leve.leve > CONFIG_BACKLIGHT_MAX_LEVEL) ||
       (system_info_s.brightness_leve.leve == 0) ||
       (system_info_s.brightness_leve.setleve > CONFIG_BACKLIGHT_MAX_LEVEL) ||
...
/****************************************************************
** Function name:           Config_UiDisplayTimeInit
** Descriptions:            UI风格配置
** input parameters:        无
** output parameters:       无
** Returned value:          无
...
*****************************************************************/
void Config_UiDisplayTimeInit(void)
{
    system_info_s.ui_display_time = UI_DISPLAY_TIME_RECOMMEND;
}

/****************************************************************
** Function name:           Config_UiDisplayTimeCheck
** Descriptions:            UI风格配置
** input parameters:        无
** output parameters:       无
** Returned value:          无
...
** Created Date:            2018-08-07
*****************************************************************/
void Config_UiDisplayTimeCheck(void)
{ 
    if(system_info_s.ui_display_time > UI_DISPLAY_TIME_MAX 
      || system_info_s.ui_display_time < UI_DISPLAY_TIME_MIN)   
    {
        Config_UiDisplayTimeInit();       
    }
}
