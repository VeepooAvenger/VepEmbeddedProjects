...
#define FUNCTION_SUPPORT_BP                 0//2       //血压
...
#define FUNCTION_SUPPORT_FIND_PHONE         0//2       //手机查找支持
#define FUNCTION_SUPPORT_ACCURATE_BP        0       //高端血压动态校准
#define FUNCTION_SUPPORT_STOPWATCH          2       //秒表支持

#define FUNCTION_SUPPORT_UI_STYLE           5       //支持UI风格种类 
...
#define FUNCTION_BLE_DISCONNECT_REMIND      0       //蓝牙断连提醒
...
#define CONFIG_BACKLIGHT_MIN_LEVEL_RECOMMEND     2           //夜间调光等级
