...
void App_SystemFlagInit(void)
{
    ...
    system_flag_s.bp_flag = Product_GetBpFunctionState();
...
void App_Init(void)
{
    ...
    {
        system_flag_s.accworking = 0;
        system_flag_s.adc_type = 0;
        system_flag_s.advertising = 0;
        system_flag_s.battery_dect = 0;
        memset(&system_flag_s, 0, sizeof(system_flag_s));
        memset(&system_flag_s, 0, sizeof(system_flag_s));
    }
        ...
        if(system_flag_s.sign_off != 0x01 && system_flag_s.ota_encrypt)
        {
            switch(t_event)
            {
                ...
                case APP_DEV_SETBLENAME_EVENT:
                    ...
                    break;
                case APP_DEV_SETBP_FUNCTION_EVENT:
                    App_DeleteEvent(t_event);
