...
extern daily_heart_average_t daily_heart_average_s;     
...
/****************************************************************
** Function name:           Gui_DataSetUiStyle
** Descriptions:            获取UI界面风格
** input parameters:        ui_style：设置的风格
** output parameters:       无
** Returned value:          无
** Created by:              WJ              
** Created Date:            2018-08-08
*****************************************************************/ 
void Gui_DataSetUiStyle(uint8_t ui_style)
{
    if(ui_style < FUNCTION_SUPPORT_UI_STYLE)
    {
        system_info_s.ui_style = ui_style;
...
/****************************************************************
** Function name:           Gui_DataGetSportsTarget
** Descriptions:            获取运动达标步数
** input parameters:        
** output parameters:       
** Returned value:          
** Created by:              YX              
...
*****************************************************************/ 
uint32_t Gui_DataGetSportsTarget(void)
{  
    return system_info_s.user_info.user_moving_target;
}

/****************************************************************
** Function name:           Gui_DataGetSleepTime
...
/****************************************************************
** Function name:           Gui_DataGetSleepInfo
** Descriptions:            获取睡眠时间(深睡，浅睡，睡眠质量)
** input parameters:        无
** output parameters:       all_time：睡眠总时间；shallow_sleep_time：浅睡
                            deep_sleep_time：深睡；qualit：睡眠质量
** Created by:              WJ              
** Created Date:            2018-08-08
*****************************************************************/ 
uint16_t Gui_DataGetSleepInfo(uint16_t *all_time, uint16_t *shallow_sleep_time, 
                              uint16_t *deep_sleep_time, uint8_t *quality)
{  
    uint16_t sleep_time = 0;
    
    sleep_time = Sleep_GetTimeInfo(all_time, shallow_sleep_time, deep_sleep_time, quality);
    if(sleep_time == 0)
    {
        Gui_DataSleepToRecalculate();
    }
...
/****************************************************************
** Function name:           Gui_DataGetBPprogress
** Descriptions:            获取血压测量进度
** input parameters:        
** output parameters:       
** Returned value:          无
** Created by:              JSH              
...
*****************************************************************/ 
uint8_t Gui_DataGetBPprogress(void)
{  
    return Bp_GetProgress();
}
...
uint8_t Gui_DataGetPinBatteryState(void)
{
    if(Battery_IsCharging() || Battery_IsChargingFull())
    {
        return 1;
    }
...
/****************************************************************
** Function name:           Gui_DataStopWatchIsRun
** Descriptions:            秒表是否正在运行
** input parameters:        
** output parameters:       无 
** Returned value:          返回0:没有运行,1:正在运行
** Created by:              JSH              
** Created Date:            2018-07-17
*****************************************************************/ 
uint8_t Gui_DataStopWatchIsRun(void)
{    
    if(Watch_IsRun())
    {
        return 1;
...
/****************************************************************
** Function name:           Gui_DataCountDownIsRun
** Descriptions:            获取倒计时是否运行
** input parameters:        无
** output parameters:       无 
** Returned value:          0，空闲或者暂停；1，运行中
** Created by:              WJ              
** Created Date:            2017-07-28
*****************************************************************/ 
uint8_t Gui_DataCountDownIsRun(void)
{
    if(Countdown_GetState() == COUNTDOWN_STATE_RUN)
    {
        return 1;
    }
    return 0;
...
/****************************************************************
** Function name:           Gui_DataCountDownPause
** Descriptions:            倒计时暂停
** input parameters:        无
** output parameters:       无 
** Returned value:          无
...
*****************************************************************/ 
void Gui_DataCountDownPause(void)
{
    Countdown_SetTimeBySystemPause();;
}

/****************************************************************
** Function name:           Gui_DataCountDownConfigSecond
** Descriptions:            获取倒计时配置时间
** input parameters:        无
** output parameters:       无 
** Returned value:          无
** Created by:              JSH            
** Created Date:            2018-07-17
*****************************************************************/ 
uint32_t Gui_DataCountDownConfigSecond(void)
{
    return system_info_s.countdown_config.countdown_second; 
}

/****************************************************************
** Function name:           Gui_DataCountDownCurrentSecond
** Descriptions:            获取倒计时当前时间
** input parameters:        无
** output parameters:       无 
** Returned value:          无
** Created by:              JSH            
** Created Date:            2018-07-17
*****************************************************************/ 
uint32_t Gui_DataCountDownCurrentSecond(void)
{
    return Countdown_GetCurrentSecond(); 
}
...
/****************************************************************
** Function name:           Gui_DataClearMessage
** Descriptions:            清除消息记录
** input parameters:        无
** output parameters:       无 
** Returned value:          无
...
*****************************************************************/ 
void Gui_DataClearMessage(void)
{    
    Message_Clear();
}
...
/****************************************************************
** Function name:           Gui_DataClearUnReadPhysMessage
...
*****************************************************************/ 
void Gui_DataClearUnReadPhysMessage(void)
{    
   if(phys_remind_info_s.is_reading == 1)
   {
...
/****************************************************************
** Function name:           Gui_DataGetDisplayHeart
** Descriptions:            获取主界面的显示心率
** input parameters:        无
** output parameters:       无
** Returned value:          心率
** Created by:              JSH              
...
*****************************************************************/
uint8_t Gui_DataGetDisplayHeart(void)
{
    return system_flag_s.display_heart;
}


/****************************************************************
** Function name:           Gui_DataGetDailyHeartArray
** Descriptions:            获取日常心率数值指针
** input parameters:        无
** output parameters:       无
** Returned value:          日常心率数值指针
** Created by:              JSH              
** Created Date:            2018-08-10
*****************************************************************/ 
uint8_t* Gui_DataGetDailyHeartArray(void)
{
    return daily_heart_average_s.heart_arg;
}

/****************************************************************
** Function name:           Gui_DataGetDailyHeartMax
** Descriptions:            获取日常心率最大值
** input parameters:        无
** output parameters:       无
** Returned value:          日常心率最大值
** Created by:              JSH              
** Created Date:            2018-08-10
*****************************************************************/ 
uint8_t Gui_DataGetDailyHeartMax(void)
{
    return daily_heart_average_s.max_heart;
}

/****************************************************************
** Function name:           Gui_DataGetDailyHeartMin
** Descriptions:            获取日常心率最小值
** input parameters:        无
** output parameters:       无
** Returned value:          日常心率最小值
** Created by:              JSH              
** Created Date:            2018-08-10
*****************************************************************/ 
uint8_t Gui_DataGetDailyHeartMin(void)
{
    return daily_heart_average_s.min_heart;
}

/****************************************************************
** Function name:           Gui_DataGetUiDisplayTime
** Descriptions:            获取UI显示时长
** input parameters:        无
** output parameters:       无
** Returned value:          显示时长
** Created by:              WJ              
** Created Date:            2018-08-10
*****************************************************************/ 
uint8_t Gui_DataGetUiDisplayTime(void)
{
    if(system_info_s.ui_display_time < UI_DISPLAY_TIME_MIN
      || system_info_s.ui_display_time > UI_DISPLAY_TIME_MAX)
    {
        return UI_DISPLAY_TIME_RECOMMEND;
    }
    else
    {
        return system_info_s.ui_display_time;
    }
}

/****************************************************************
** Function name:           Gui_DataGetBackLightLevel
** Descriptions:            获取LCD背光亮度等级
** input parameters:        无
** output parameters:       无
** Returned value:          亮度等级
** Created by:              WJ              
...
*****************************************************************/ 
uint8_t Gui_DataGetBackLightLevel(void)
{
    uint8_t  back_light_level = 0;
    uint16_t oled_min_time = 0;
    uint16_t oled_max_time = 0;
    uint16_t current_time = 0;
   
    current_time = clock->hour * 60 + clock->minutes;     
    oled_min_time = system_info_s.brightness_leve.s_hour * 60 + system_info_s.brightness_leve.s_minute;
    oled_max_time = system_info_s.brightness_leve.e_hour * 60 + system_info_s.brightness_leve.e_minute;

    if(oled_min_time <= oled_max_time)
    {
        if(oled_min_time <= current_time && current_time <= oled_max_time)
        {
            back_light_level = system_info_s.brightness_leve.setleve;
        }
        else
        {
            back_light_level = system_info_s.brightness_leve.leve;
        }
    }
    else 
    {
        if(current_time >= oled_min_time || current_time <= oled_max_time)
        {
            back_light_level = system_info_s.brightness_leve.setleve;
        }
        else
    ...
    if(back_light_level == 0 || back_light_level > BACKLIGHT_MAX_CHANAGE_LEVEL)
    {
        back_light_level = CONFIG_BACKLIGHT_MAX_LEVEL_RECOMMEND;
    }
    return back_light_level;
}
