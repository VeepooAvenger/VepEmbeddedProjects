...
#define NUS_BASE_UUID                  {{0x00,0x00,0x00, 0x00, 0x00, 0x00, 0x00, 0xB0, 0x00, 0x40, 0x51, 0x04, 0x01, 0x00, 0x08, 0xF0}} /**< Used vendor specific UUID. */
