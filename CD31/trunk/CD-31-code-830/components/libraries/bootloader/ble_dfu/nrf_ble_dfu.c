...
#include "ble_user_services.h"

#define ADVERTISING_LED_PIN_NO               BSP_LED_0                                              /**< Is on when device is advertising. */
#define CONNECTED_LED_PIN_NO                 BSP_LED_1                                              /**< Is on when device has connected. */

#define DEVICE_NAME                          "DFU-52"                                              /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "NordicSemiconductor"                                  /**< Manufacturer. Will be passed to Device Information Service. */

#define MIN_CONN_INTERVAL                    (uint16_t)(MSEC_TO_UNITS(30, UNIT_1_25_MS))            /**< Minimum acceptable connection interval. */
#define MAX_CONN_INTERVAL_MS                 30//50                                                     /**< Maximum acceptable connection interval in milliseconds. */
#define MAX_CONN_INTERVAL                    (uint16_t)(MSEC_TO_UNITS(50, UNIT_1_25_MS)) /**< Maximum acceptable connection interval . */
...
//    BLE_UUID_BLE_ASSIGN(service_uuid, BLE_DFU_SERVICE_UUID);
    ...
    user_data.data.p_data = ble_gap_address.addr;//p_data;//   
...
//WJ.20170513.解决app不能识别设备的问题，03 03 FF FF
...
static void ble_evt_dispatch(ble_evt_t * p_ble_evt)
{
    ...
    ble_nus_on_ble_evt(get_ble_nus(), p_ble_evt);   //WJ.2016.10.22
