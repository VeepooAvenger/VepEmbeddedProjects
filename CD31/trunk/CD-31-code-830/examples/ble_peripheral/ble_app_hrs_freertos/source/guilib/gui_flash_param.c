...
// 关机界面
// 关机界面-无物理按键时
const uint8_t icon_16_poweroff_nokey_icon_coord[2][2] = {{11, 36},{83, 85}};
const uint32_t icon_16_poweroff_nokey_icon_addr[2] = 
{
    ICON_POWEROFF_ICON1_ADDR,ICON_POWEROFF_ICON2_ADDR
};
