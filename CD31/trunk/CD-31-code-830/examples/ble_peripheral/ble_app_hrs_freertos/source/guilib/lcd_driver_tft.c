...
{
	#if SPI_1_2_USE_DMALCD_DriverDeselect
    ...
    address_offset = address + 0x200000;
    ...
    while(send_index < data_len)
    {
        ...
        Extflash_Read(address_offset + send_index, send_len, display_buf);       
...
// 镭科1.2 
	...
	LCD_DriverWriteCmd( 0x2A);     //Column Address Set
    LCD_DriverWriteDataByte( 0x00);   
    LCD_DriverWriteDataByte( 0x00);   //0
    LCD_DriverWriteDataByte( 0x00);   
    LCD_DriverWriteDataByte( 0xEF);   //239
    LCD_DriverWriteCmd( 0x2B);     //Row Address Set
    LCD_DriverWriteDataByte( 0x00);   
    LCD_DriverWriteDataByte( 0x00);   //0
    LCD_DriverWriteDataByte( 0x00);   
    LCD_DriverWriteDataByte( 0xEF);   //239
    ...
    LCD_DriverWriteCmd(0xBB);     //VCOM  
    LCD_DriverWriteDataByte(0x1E);   
    ...
    LCD_DriverWriteDataByte(0x35);   
    LCD_DriverWriteDataByte(0x3F);   
    LCD_DriverWriteDataByte(0x4D);   
    LCD_DriverWriteDataByte(0x29);   
    LCD_DriverWriteDataByte(0x14);   
    LCD_DriverWriteDataByte(0x14);   
    LCD_DriverWriteDataByte(0x2E);   
    LCD_DriverWriteDataByte(0x32);   
    ...
    LCD_DriverWriteDataByte(0x25);   
    LCD_DriverWriteDataByte(0x36);   
    LCD_DriverWriteDataByte(0x40);   
    LCD_DriverWriteDataByte(0x4C);   
...
//    LCD_DriverWriteCmd(0x29); 
    ...
    LCD_DriverWriteCmd( 0xB7);     
    LCD_DriverWriteDataByte( 0x75);   

    LCD_DriverWriteCmd( 0xBB);     
    LCD_DriverWriteDataByte( 0x3D);   //Vcom=1.625V

    LCD_DriverWriteCmd( 0xC2);     
    LCD_DriverWriteDataByte( 0x01);   

    LCD_DriverWriteCmd( 0xC3);     
    LCD_DriverWriteDataByte( 0x19);   //GVDD=4.8V 

    LCD_DriverWriteCmd( 0xC4);     
    LCD_DriverWriteDataByte( 0x20);   //VDV, 0x20:0v

    LCD_DriverWriteCmd( 0xC6);     
    LCD_DriverWriteDataByte( 0x0F);   //0x0F:60Hz        	

    LCD_DriverWriteCmd( 0xD0);     
    LCD_DriverWriteDataByte( 0xA4);   
    LCD_DriverWriteDataByte( 0xA1);   

    LCD_DriverWriteCmd( 0xD6);     
    LCD_DriverWriteDataByte( 0xA1);

    LCD_DriverWriteCmd( 0xE0);     
    LCD_DriverWriteDataByte( 0x70);   
    ...
    LCD_DriverWriteDataByte( 0x09);   
    LCD_DriverWriteDataByte( 0x06);   
    LCD_DriverWriteDataByte( 0x2B);   
    LCD_DriverWriteDataByte( 0x34);   
    LCD_DriverWriteDataByte( 0x41);   
    LCD_DriverWriteDataByte( 0x07);   
