...
void Gui_PageTurnOff(uint16_t index, uint8_t *ble_name, uint8_t *mac_data, uint8_t *ver_data,uint8_t language)
{
	...
	if(index == 0)
	{
		...
		Gui_PageClearBackground(0, 
								...
								MAX_X_SIZE,
								icon_16_poweroff_nokey_icon_coord[1][1] - (icon_16_poweroff_nokey_icon_coord[0][1] + ICON_POWEROFF_ICON1_HIGH));
	}
	...
	{
		Gui_PageClearBackground(0, 
								icon_16_poweroff_nokey_icon_coord[1][1], 
								icon_16_poweroff_nokey_icon_coord[1][0],
								ICON_POWEROFF_ICON2_HIGH);
	}
	...
	if(index == 0)
	{
		Gui_PageClearBackground(icon_16_poweroff_nokey_icon_coord[1][0] + ICON_POWEROFF_ICON2_WIDE, 
								icon_16_poweroff_nokey_icon_coord[1][1], 
								MAX_X_SIZE - (icon_16_poweroff_nokey_icon_coord[1][0] + ICON_POWEROFF_ICON2_WIDE),
								ICON_POWEROFF_ICON2_HIGH);
		
		Gui_PageClearBackground(0, 
								icon_16_poweroff_nokey_icon_coord[1][1] + ICON_POWEROFF_ICON2_HIGH, 
								MAX_X_SIZE,
								MAX_Y_SIZE - (icon_16_poweroff_nokey_icon_coord[1][1] + ICON_POWEROFF_ICON2_HIGH));
	}    
	...
	if(index == 0)
	{
		...
		LCD_DriverWriteDataFromExtFlash(icon_16_poweroff_nokey_icon_addr[0], ICON_POWEROFF_ICON1_SIZE);
	}
	...
	if(index == 0)
	{
		LCD_SetPosition(icon_16_poweroff_nokey_icon_coord[1][0], icon_16_poweroff_nokey_icon_coord[1][1], 
						ICON_POWEROFF_ICON2_WIDE, ICON_POWEROFF_ICON2_HIGH);
		LCD_DriverWriteDataFromExtFlash(icon_16_poweroff_nokey_icon_addr[1], ICON_POWEROFF_ICON2_SIZE);
	}
